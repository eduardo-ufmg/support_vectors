...
def filter_by_degree(X: np.ndarray, y: np.ndarray, degrees: np.ndarray, filter: str) -> tuple[np.ndarray, np.ndarray]:
    """
...
def class_average_filter(X: np.ndarray, y: np.ndarray, degrees: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
...
def interclass_average_filter(X: np.ndarray, y: np.ndarray, degrees: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
...
def zero_degree_filter(X: np.ndarray, y: np.ndarray, degrees: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
